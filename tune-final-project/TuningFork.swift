...
//  tune-final-project
//
//  Original library by Comyar Zaheri (Incompatible with Swift).
//  Original library was referenced, refactored, and modified to work with
//  Swift 4.2 by Aneesh Ashutosh.
...
@objc public class Tuner: NSObject {
    ...
    fileprivate var timer: CHRDispatchTimer?
    ...
    public func start() {
        ...
        if timer == nil {
            timer = CHRDispatchTimer(interval: 0.03, executionBlock: { (t, i) -> Void in
